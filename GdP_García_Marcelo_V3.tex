...
\begin{enumerate}
	...
	\item Requerimientos de documentación
		\begin{enumerate}
			...
			\item Se debe generar un informe de avance.
			\item Se debe generar una memoria de proyecto.
...
\item Investigación (62 hs)
	\begin{enumerate}
	\item Prueba en campo de tecnologías LoRA / LoRAWAN (26 hs).
	\item Prueba en campo de tecnologías Zigbee / Wi-Fi (26 hs).
	\item Determinar método de medición de datos (2 hs).
	\item Evaluar herramientas de representación de datos con dashboards y gráficos (8 hs).
	\end{enumerate}
\item Backend (63 hs)
	\begin{enumerate}
...
\item Interfaz de comunicación (142 hs)
	...
	\item Creación de biblioteca ModBUS (22 hs).
	\item Creación de biblioteca SPI para adaptador Ethernet WZ5100 (35 hs).
