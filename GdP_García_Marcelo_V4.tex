...
Demoras en la entrega de componente.\\
Deterioro de prototipo.\\
No disponibilidad de maquina.\\
No disponibilidad de tiempo por ejecución de otros proyectos.\\
No disponibilidad de los técnicos relacionados con el proyecto.\\
Falla de los módulos.
...
\begin{itemize}
	\item Severidad (S): 7.\\ La prueba de los módulos es de vital importancia para las tareas de desarrollo posteriores.
...
\begin{itemize}
	\item Severidad (S): 10.\\Los prototipos son indispensables para la prueba del sistema, además se demoraría 75 días en reponerlos.
...
\begin{itemize}
	\item Severidad (S): 6.\\No se dispone de las variables para la puesta en marcha del sistema.
	\item Ocurrencia (O): 4.\\En el caso de presentarse se optará por una máquina de similares características.
\end{itemize}
...
\begin{itemize}
	...
	\item Ocurrencia (O): 5.\\La demanda de horas extras el habitual en momentos de picos de producción.
\end{itemize}

Riesgo 5: Cambio de tecnología de radio a utilizar
\begin{itemize}
	\item Severidad (S): 7.\\Impacta en el tiempo de desarrollo de firmware de las interfaces.
	\item Ocurrencia (O): 2.\\Se someterá los módulos de radio a pruebas de campo para verificar su cumplimiento de requerimientos.
\end{itemize}

Riesgo 6: Cambio de tecnología de radio a utilizar
\begin{itemize}
	\item Severidad (S): 7.\\Impacta en el tiempo de desarrollo de firmware de las interfaces.
	\item Ocurrencia (O): 2.\\Se someterá los módulos de radio a pruebas de campo para verificar su cumplimiento de requerimientos.
\end{itemize}
